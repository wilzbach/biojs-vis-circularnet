...
function circular(config){
  ...
  var diameter = config.diameter || 960,
  radius = diameter / 2,
  ...
  node = svg.append("g").selectAll(".node");
    ...
    var nodes = cluster.nodes(packageHierarchy(config.data)),
    ...
    node = node
      ...
      .on("click", function(d){
          self.trigger("click", {key: d.name, imports: d.imports});  
      });
  //});
...
Events.mixin(circular.prototype);
